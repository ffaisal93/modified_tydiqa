...
EVAL_SCRIPT="$HOME/dialect/software/bi-att-flow/squad/evaluate-v1.1.py"
...
TYDIQA_GOLDP_DIR=$HOME/dialect/data/goldp/tydiqa-goldp-v1.1-dev
TYDIQA_VERSION="1.1"
...
for lang in english arabic bengali finnish indonesian swahili korean russian telugu; do
  dataset_file="${TYDIQA_GOLDP_DIR}/tydiqa-goldp-dev-${lang}.json"
